    ...
    return Semantics(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          iconTheme:
              theme.primaryIconTheme.copyWith(color: AppStyles.kPrimaryColor),
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                icon: Padding(
                  ...
                  child: Icon(Icons.search, color: AppStyles.kPrimaryColor),
                ),
                suffixIcon: widget.delegate.buildActions(context)[0],
              ),
            ),
          ),
        ),
